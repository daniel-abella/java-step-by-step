...
public class CadastroContas {
	 ...
	 *            banco de dados de contas.Esta exceção vem da chamada ao repositório de
	...
	public void cadastrar(ContaAbstrata c)
		throws ContaExistenteException, ErroAcessoRepositorioException {
