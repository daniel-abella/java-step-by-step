...
public class Snippet<E extends Comparable<E>> {
	public static void append(List list) {
		list.add("0042");
	}

	public static <E extends Date> void append2(List list) {
		list.add("0042");
	}
	...
	private static <T extends Collection<String>> void listar(T lista){
